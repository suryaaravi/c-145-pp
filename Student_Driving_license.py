...
root=Tk()
root.title("student_Driving_license")
...
label_name=Label(root,text=["Black pink"])
label_dob=Label(root,text=["8 August 2000"])
label_pin=Label(root,text=["451478"])
label_address=Label(root,text=["Seoul Forest Trimage"])
...
button1 = Button(root,text=["show my driving lisence"]) 
